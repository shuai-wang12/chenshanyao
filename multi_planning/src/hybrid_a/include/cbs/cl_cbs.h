...
{
public:
    CL_CBS(environment &_env,environment &_env2, carconfig &_cfg, HybridAStarParam &_hAParam, TrajPlannerConfig &config);
    CL_CBS() = default;
    ~CL_CBS() = default;
    // 第二项是时间
    ...
    bool searchProgress(std::vector<Vec3d> &initialStates,
